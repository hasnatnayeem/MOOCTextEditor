...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		//for (int numToCheck = start; numToCheck < 5 + start;
				...
				numToCheck += increment)
		{
			...
			long startTime, endTime, estTime;

			startTime = System.nanoTime();

			for (int i = 1; i <= trials; i++)
			{
				BasicDocument b = new BasicDocument(str);
				b.getFleschScore();
			}
			...
			System.out.print(estTime / 1000000000.0 + "\t");
			...
			for (int i = 1; i <= trials; i++)
			{
				EfficientDocument b = new EfficientDocument(str);
				b.getFleschScore();
			}
			endTime = System.nanoTime();
			
			estTime = endTime - startTime;
			//estTime = estTime / 1000000000.0;
